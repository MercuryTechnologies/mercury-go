...
func TestCategoryNew(t *testing.T) {
	...
	_, err := client.Categories.New(context.TODO(), mercury.CategoryNewParams{
		Name:                     "name",
...
func TestCategoryUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Categories.Update(
		...
		mercury.CategoryUpdateParams{
			Name:                     mercury.String("name"),
			VisibleForCardSpend:      mercury.Bool(true),
			VisibleForOther:          mercury.Bool(true),
			VisibleForReimbursements: mercury.Bool(true),
		},
	)
	if err != nil {
		var apierr *mercury.Error
...
func TestCategoryListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Categories.List(context.TODO(), mercury.CategoryListParams{
		EndBefore:  mercury.String("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
		Limit:      mercury.Int(1),
		Order:      mercury.CategoryListParamsOrderAsc,
...
func TestCategoryDelete(t *testing.T) {
	...
	err := client.Categories.Delete(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
	if err != nil {
		var apierr *mercury.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
