...
func TestStatementTreasuryListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Statements.Treasury.List(
		...
		mercury.StatementTreasuryListParams{
			DocumentType: mercury.StatementTreasuryListParamsDocumentTypeMonthlyStatement,
			EndBefore:    mercury.String("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
			Limit:        mercury.Int(1),
			Order:        mercury.StatementTreasuryListParamsOrderAsc,
