...
func TestAccountGet(t *testing.T) {
	...
	_, err := client.Account.Get(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
	if err != nil {
...
func TestAccountListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Account.List(context.TODO(), mercury.AccountListParams{
...
func TestAccountListCards(t *testing.T) {
	...
	_, err := client.Account.ListCards(context.TODO(), "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
	if err != nil {
		var apierr *mercury.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
