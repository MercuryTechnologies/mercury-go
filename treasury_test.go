...
func TestTreasuryListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Treasury.List(context.TODO(), mercury.TreasuryListParams{
		EndBefore:  mercury.String("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
		Limit:      mercury.Int(1),
		Order:      mercury.TreasuryListParamsOrderAsc,
...
func TestTreasuryGetStatementsWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Treasury.GetStatements(
		context.TODO(),
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		mercury.TreasuryGetStatementsParams{
			DocumentType: mercury.TreasuryGetStatementsParamsDocumentTypeMonthlyStatement,
			EndBefore:    mercury.String("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
			Limit:        mercury.Int(1),
			Order:        mercury.TreasuryGetStatementsParamsOrderAsc,
			StartAfter:   mercury.String("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"),
		},
	)
	if err != nil {
