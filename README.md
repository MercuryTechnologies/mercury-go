...
```sh
go get -u 'github.com/MercuryTechnologies/mercury-go@v0.13.0'
```
...
`*mercury.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `mercury.File(reader io.Reader, filename string, contentType string)`
