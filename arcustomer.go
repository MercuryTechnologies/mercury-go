...
func (r *ArCustomerService) List(ctx context.Context, query ArCustomerListParams, opts ...option.RequestOption) (res *pagination.CursorIDCustomers[CustomerResponse], err error) {
...
// Retrieve a paginated list of customers. Supports cursor-based pagination with
// limit, order, start_after, and end_before query parameters.
func (r *ArCustomerService) ListAutoPaging(ctx context.Context, query ArCustomerListParams, opts ...option.RequestOption) *pagination.CursorIDCustomersAutoPager[CustomerResponse] {
	return pagination.NewCursorIDCustomersAutoPager(r.List(ctx, query, opts...))
}
